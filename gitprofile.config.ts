  ...
  projects: {
    github: {
      ...
      manual: {
        ...
        projects: ['PriscillaGgit/genomeanalysis', 'PriscillaGgit/microbiometutorial', 'PriscillaGgit/transcriptome'], // List of repository names to display. example: ['arifszn/my-project1', 'arifszn/my-project2']
      },
    },
    external: {
      header: 'My Projects',
  ...
  publications: [
    {
      ...
      description:
        'We isolated three organisms from pond sediment with activity against Bacillus subtilis and/or Staphylococcus aureus. These isolates were sequenced and identified as Priestia megaterium, Pseudomonas aeruginosa, and a Pseudomonas sp. in the putida group. Each isolate contains one or more biosynthetic gene clusters potentially contributing to the observed antimicrobial phenotype.',
    },
    {
